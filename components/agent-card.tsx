        ...
        <div className="mb-5 flex items-start justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-1">
            ...
            {agent.inftTokenId !== null ? (
              <span
                className="inline-flex items-center gap-1 rounded-lg bg-violet-50 px-2 py-0.5 text-[10px] font-bold tracking-wide text-violet-700"
                title={`ERC-7857 iNFT #${agent.inftTokenId} on 0G Galileo testnet${agent.inftMintTxHash ? `\nMint tx: ${agent.inftMintTxHash}` : ""}`}
              >
