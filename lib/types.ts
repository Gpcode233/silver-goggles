...
export type AgentRecord = {
  ...
  inftMintTxHash: string | null;
  inftOwnerAddress: string | null;
};

export type RunArchiveStatus = "pending" | "archived" | "failed" | "skipped";
...
export type RunRecord = {
  ...
  archiveStatus: RunArchiveStatus;
...
export type RunArchiveManifest = {
  ...
  cost: number;
  computeMode: string;
  computeProviderAddress: string | null;
  createdAt: string;
};
